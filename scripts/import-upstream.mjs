...
const MANUAL_EXCLUSIONS = new Map([
  ...
  ['mylio-photos-plus', 'no citable price: mylio.com/pricing 301-redirects to the homepage, and the homepage renders no price at all — the plan area is a set of "Free Gift with Purchase" banners with the figures injected only inside a checkout flow. Verified with curl and in a real Chrome session on 2026-07-31. Same standing as dovetail, maze and timeular.'],
  ['box-personal-pro', 'price unreadable and uncorroborated: box.com/pricing and box.com/pricing/individual both return a Cloudflare interstitial that neither curl nor a real Chrome session cleared (waited, retried, 2026-07-31), and unlike the pipedrive case there is no long-standing published figure corroborating the "$14 Personal Pro" upstream recorded. Excluded rather than shipped as a confident-looking citation; the reply-io precedent.'],
  ['groove', 'the product upstream recorded no longer exists: groovehq.com 301-redirects to helply.com, Groove having relaunched as Helply with a different name, a different positioning (AI-native B2B support) and a completely different pricing model — $1 per ticket, minimum 250 tickets a month, minimum $3,000 annual contract, annual billing only. The recorded "$20 Standard per user" tier is gone. Importing it under the old name and slug would put "Groove is replaceable" on a page that says Helply, which is the mismatch the domain-safety rule exists to prevent. Verified 2026-07-31.'],
  ['timeular', 'no citable price: timeular.com redirects to early.app after the rebrand to EARLY, and early.app/pricing prints no price at all — the plan cards (Personal, Personal Pro, ...) carry feature lists and a "Start free trial" button and nothing else, in a real Chrome session after scrolling and waiting. Same standing as dovetail and maze: there is no number on the page to cite. Verified 2026-07-31.'],
  ...
  ['final-round-ai', 'no citable price: finalroundai.com/pricing 301-redirects to the homepage, /pricing-plans and /plans both 404, and the only figure anywhere on the site is an FAQ sentence — "paid subscriptions starting at $25 per month" — that names no tier. The recorded "$99 Pro" plan appears nowhere. Same standing as dovetail, maze, timeular and mylio-photos-plus: there is no plan-level number on the vendor site to cite. Verified with curl and in a real Chrome session on 2026-07-31.'],
  ['jobscan', 'price unreadable and uncorroborated: jobscan.co/pricing returns a Cloudflare interstitial ("Un instant…") that neither curl nor a real Chrome session cleared, after a 15-second wait and two attempts. Unlike the pipedrive case there is no independent source this project can cite for the "$49.95 Premium" figure upstream recorded, and batches 11-15 found 15-20 of every 25 upstream prices stale. Excluded rather than shipped as a confident-looking citation; the reply-io and box-personal-pro precedent. Verified 2026-07-31.'],
  ['resume-worded', 'no citable price: resumeworded.com/pricing, /pricing.php and /upgrade all 404, /pro redirects to a login wall, and the homepage prints no plan price. The recorded "$49 Pro" tier cannot be substantiated from any public vendor page. Verified with curl on 2026-07-31.'],
  ['teal-plus', 'price unreadable: tealhq.com/pricing returns Cloudflare\'s "Attention Required!" page to curl and to a real Chrome session alike, and no other Teal page publishes the "$29 Teal Plus" figure upstream recorded. Same standing as jobscan. Verified 2026-07-31.'],
